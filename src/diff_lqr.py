...
def get_qra_bar(
    dims: ModelDims, params: Params, tau_bar: Array, tau_bar_f: Array
...
def dlqr(dims: ModelDims, params: Params, tau_guess: Array) -> Array:
    """
...
def fwd_dlqr(
    dims: ModelDims, params: Params, tau_guess: Array
) -> Tuple[Array, Tuple[Params, Tuple[Array, Array, Array, Array]]]:
