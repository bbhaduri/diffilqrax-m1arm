...
class TestPLQR(unittest.TestCase):
    ...
    def test_time(self):
        ...
        Ts = [
            ...
            10000,
            20000,
        ]  # ,10000]#,100000] #, 50000, 100000, 200000, 500000, 1000000] #10000]
        ...
        for i, n in enumerate(ns):
            axes[0].plot(
                Ts,
                parallel_lqr_times_0[i],
                label=f"Parallel LQR n = {n}",
                color=colors[i],
            )
            axes[0].plot(
                Ts,
                normal_lqr_times_0[i],
                label=f"Normal LQR n = {n}",
                color=colors[i],
                linestyle="--",
            )
